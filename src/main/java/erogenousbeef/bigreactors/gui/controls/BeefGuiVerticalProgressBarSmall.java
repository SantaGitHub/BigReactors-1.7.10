...
public abstract class BeefGuiVerticalProgressBarSmall extends BeefGuiControlBase {
    private final static int controlWidth = 14;
    private final static int controlHeight = 42;
    ...
    public BeefGuiVerticalProgressBarSmall(BeefGuiBase container, int x, int y) {
