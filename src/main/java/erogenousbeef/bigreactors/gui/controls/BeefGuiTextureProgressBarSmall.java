...
public abstract class BeefGuiTextureProgressBarSmall extends BeefGuiVerticalProgressBarSmall {
    ...
    public BeefGuiTextureProgressBarSmall(BeefGuiBase container, int x, int y) {
        super(container, x, y);
