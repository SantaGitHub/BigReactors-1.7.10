...
public class ContainerLiquidizer extends Container {
    protected TileEntityLiquidizer _entity;

    public ContainerLiquidizer(TileEntityLiquidizer entity, EntityPlayer player) {
        super();
        _entity = entity;
        addSlots();
    ...
    protected void addSlots() {
        ...
        // Output Slot
        //addSlotToContainer(new SlotRemoveOnly(_entity, 2, 116, 41));
    }
