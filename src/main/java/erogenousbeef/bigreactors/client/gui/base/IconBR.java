...
import erogenousbeef.bigreactors.core.client.render.IWidgetMap;
import net.minecraft.util.ResourceLocation;
import org.lwjgl.opengl.GL11;

public enum IconBR implements IWidgetIcon {
    ...
    IconBR(int x, int y, IconBR overlay) {
        this(x, y, 16, 16, overlay);
    }

    IconBR(int x, int y, int width, int height) {
        this(x, y, width, height, null);
    }

    private IconBR(int x, int y, int width, int height, IconBR overlay) {
        this.x = x;
        this.y = y;
        this.width = width;
        this.height = height;
