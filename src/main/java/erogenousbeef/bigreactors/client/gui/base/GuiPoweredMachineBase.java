...
import erogenousbeef.bigreactors.common.tileentity.base.TileEntityPoweredBasicMachine;
...
public class GuiPoweredMachineBase <T extends TileEntityPoweredBasicMachine> extends GuiMachineBase<T> {
    ...
    protected void updatePowerBarTooltip(java.util.List<String> text) {
