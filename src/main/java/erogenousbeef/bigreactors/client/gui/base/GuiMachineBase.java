...
public class GuiMachineBase <T extends TileEntityBasicMachine> extends GuiContainerBaseBR {
    ...
    protected GuiMachineBase(T machine, Container par1Container, String... guiTexture) {
        ...
        y += 19;
        recipeButton = new IconButton(this, RECIPE_ID, x, y, IconBR.RECIPE);
    ...
    protected boolean showRecipeButton() {
        return BRLoader.proxy.isNeiInstalled();
    }
    ...
    protected String formatProgressTooltip(int scaledProgress, float progress) {
        return MessageFormat.format(BRLoader.lang.localize("gui.progress"), scaledProgress);
    }
