...
public class PowerDisplayUtil {
    ...
    public static String perTickStr() {
        return BRLoader.lang.localize("power.tick");
    }

    public static String ofStr() {
        return BRLoader.lang.localize("gui.powerMonitor.of");
    }
    ...
    public static String getStoredEnergyString(ItemStack item) {
        ...
        return BRLoader.lang.localize("item.tooltip.power")+ " "+ PowerDisplayUtil.formatPower(ci.getEnergyStored(item)) + "/"
    ...
    public static String abrevation() {
        return BRLoader.lang.localize("power.rf");
    }
