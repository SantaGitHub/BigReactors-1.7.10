...
/**
 * BigReactors packet handler. As always, use packets sparingly!
 * @author AidanBrady (Mekanism)
 *
 */
public class PacketHandler
{
    public SimpleNetworkWrapper netHandler = NetworkRegistry.INSTANCE.newSimpleChannel("BR");
    ...
    public static void encode(Object[] dataValues, ByteBuf output)
    {
        try {
            ...
            BRLog.error("Error while encoding packet data.");
            e.printStackTrace();
        }
    }
    ...
    {
        System.out.println("[BigReactors] " + log);
    }

    public static EntityPlayer getPlayer(MessageContext context)
    {
        return BigReactors.proxy.getPlayer(context);
    }
