...
import erogenousbeef.bigreactors.core.util.ItemUtil;
...
public abstract class TileEntityBasicMachine extends TileEntityBR implements ISidedInventory, IMachine, IIoConfigurable,
    ...
    public float getVolume() {
        return BigReactors.machineSoundVolume;
    }
    ...
    private void updateSound() {
        if(BigReactors.machineSoundsEnabled && hasSound()) {
            if(shouldPlaySound()) {
                if(sound == null) {
    ...
    protected boolean doSideIo() {
        ...
        boolean res = false;
        Set<Map.Entry<ForgeDirection, IoMode>> ents = faceModes.entrySet();
    ...
    public void writeCommon(NBTTagCompound nbtRoot) {
        ...
        if(faceModes != null) {
            ...
            for (Map.Entry<ForgeDirection, IoMode> e : faceModes.entrySet()) {
    ...
    public void writeToItemStack(ItemStack stack) {
        ...
        if(stack.hasDisplayName()) {
            ...
            name = BRLoader.lang.localizeExact(stack.getUnlocalizedName() + ".name");
        }
        name += " " + BRLoader.lang.localize("machine.tooltip.configured");
