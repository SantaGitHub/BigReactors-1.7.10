...
import erogenousbeef.bigreactors.common.recipe.MachineRecipeRegistry;
...
public abstract class TileEntityPoweredTask extends TileEntityPowerConsumer implements IInternalPowerReceiver, IProgressTile {
    ...
    public TileEntityPoweredTask(SlotDefinition slotDefinition) {
