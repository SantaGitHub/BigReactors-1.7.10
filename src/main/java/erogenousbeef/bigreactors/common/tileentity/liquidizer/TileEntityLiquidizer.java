...
import erogenousbeef.bigreactors.common.tileentity.base.TileEntityPoweredTask;
...
public class TileEntityLiquidizer extends TileEntityPoweredTask implements IFluidHandler, ITankAccess {
    ...
    private int liquidizerPowerUserPerTickRF = 500;
    ...
    protected boolean isMachineItemValidForSlot(int i, ItemStack itemstack) {
        ...
        return LiquidizerRecipeManager.getInstance().isValidInput(inputs);
    }
    ...
    public int getPowerUsePerTick() {
        return liquidizerPowerUserPerTickRF;
    }

    @Override
    public String getSoundName() {
        return "machine.liquidizer";
    }
