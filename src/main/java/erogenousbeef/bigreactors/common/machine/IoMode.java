...
/**
 * @author tterrag1098 (EnderIO / EnderCore)
 */
...
public enum IoMode {
    ...
    public String getLocalisedName() {
        return BRLoader.lang.localize(unlocalisedName);
    }
    ...
    public String colorLocalisedName() {
        ...
        switch (this) {
            ...
            case PUSH_PULL:
                return String.format(BRLoader.lang.localize(this.getUnlocalisedName() + ".colored"), EnumChatFormatting.GOLD, EnumChatFormatting.WHITE, EnumChatFormatting.AQUA);
            default: return loc;
        }
    }
