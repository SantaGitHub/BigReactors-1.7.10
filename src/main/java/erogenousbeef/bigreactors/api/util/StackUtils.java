package erogenousbeef.bigreactors.api.util;
...
public final class StackUtils {
    ...
    public static boolean equalsWildcard(ItemStack wild, ItemStack check1, ItemStack check2)
    {
        if(wild == null || check1 == null || check2 == null)
        {
            return check1 == wild && check2 == wild;
        }

        return (wild.getItem() == check1.getItem() && wild.getItem() == check2.getItem()) && ((wild.getItemDamage() == OreDictionary.WILDCARD_VALUE || wild.getItemDamage() == check1.getItemDamage()) && (wild.getItemDamage() == OreDictionary.WILDCARD_VALUE || wild.getItemDamage() == check2.getItemDamage()));
    }
    ...
    public static boolean equalsWildcardWithNBT(ItemStack wild, ItemStack check1, ItemStack check2)
    {
        return equalsWildcard(wild, check1, check2) && (wild.stackTagCompound == null ? (check1.stackTagCompound == null && check2.stackTagCompound == null) : ((wild.stackTagCompound == check1.stackTagCompound || wild.stackTagCompound.equals(check1.stackTagCompound)) && (wild.stackTagCompound == check2.stackTagCompound || wild.stackTagCompound.equals(check2.stackTagCompound))));
    }
    ...
    public static ItemStack subtract(ItemStack stack1, ItemStack stack2, ItemStack stack3)
    {
        if(stack1 == null)
        {
            return null;
        ...
        return size(stack1, getSize(stack1)-getSize(stack2)-getSize(stack3));
    }
    ...
    public static boolean contains(ItemStack container, ItemStack contained1, ItemStack contained2)
    {
        return equalsWildcardWithNBT(contained1, contained2, container) && container.stackSize >= contained1.stackSize && container.stackSize >= contained2.stackSize;
    }
