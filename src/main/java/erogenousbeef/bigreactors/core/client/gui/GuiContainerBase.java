...
import erogenousbeef.bigreactors.core.client.gui.ToolTipManager.ToolTipRenderer;
import erogenousbeef.bigreactors.core.client.gui.widget.GuiToolTip;
import erogenousbeef.bigreactors.core.client.gui.widget.TextFieldBR;
import erogenousbeef.bigreactors.core.client.gui.widget.VScrollbar;
...
public abstract class GuiContainerBase extends GuiContainer implements ToolTipRenderer, IGuiScreen, INEIGuiHandler {
    ...
    protected List<TextFieldBR> textFields = Lists.newArrayList();
    ...
    protected void keyTyped(char c, int key) {
        ...
        if (c == '\t') {
            for (int i = 0; i < textFields.size(); i++) {
                TextFieldBR f = textFields.get(i);
                if (f.isFocused()) {
    ...
    protected final void setText(TextFieldBR tf, String newText) {
        String old = tf.getText();
        tf.setText(newText);
        onTextFieldChanged(tf, old);
    }

    protected void onTextFieldChanged(TextFieldBR tf, String old) {
