...
public class TextFieldBR extends GuiTextField {

    public interface ICharFilter {

        boolean passesFilter(TextFieldBR tf, char c);
    }

    public static final ICharFilter FILTER_NUMERIC = new ICharFilter() {
        @Override
        public boolean passesFilter(TextFieldBR tf, char c) {
    ...
    public TextFieldBR(FontRenderer fnt, int x, int y, int width, int height) {
        this(fnt, x, y, width, height, null);
    }

    public TextFieldBR(FontRenderer fnt, int x, int y, int width, int height, ICharFilter charFilter) {
    ...
    public TextFieldBR setCharFilter(ICharFilter filter) {
        this.filter = filter;
        return this;
    }
