...
import erogenousbeef.bigreactors.core.client.gui.IAdvancedTooltipProvider;
...
public enum SpecialTooltipHandler {
    ...
    public static void addShowDetailsTooltip(List list) {
        list.add(EnumChatFormatting.WHITE + "" + EnumChatFormatting.ITALIC + BRLoader.lang.localize("tooltip.showDetails"));
    }
    ...
    public static void addTooltipFromResources(List list, String keyBase) {
        ...
        while (!done) {
            ...
            String val = BRLoader.lang.localizeExact(key);
