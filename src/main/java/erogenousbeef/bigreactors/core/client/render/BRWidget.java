...
public enum BRWidget implements IWidgetIcon {
    ...
    public static final ResourceLocation TEXTURE = new ResourceLocation("bigreactors", "textures/gui/widgets.png");
    ...
    BRWidget(int x, int y) {
        this(x, y, null);
    }

    BRWidget(int x, int y, IWidgetIcon overlay) {
        this(x, y, 16, 16, overlay);
    }

    BRWidget(int x, int y, int width, int height) {
        this(x, y, width, height, null);
    }

    BRWidget(int x, int y, int width, int height, IWidgetIcon overlay) {
        this.x = x;
        this.y = y;
        this.width = width;
        this.height = height;
