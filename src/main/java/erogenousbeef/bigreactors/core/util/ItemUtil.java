...
public class ItemUtil {
    ...
    static {
        try {
            ...
            if (Loader.isModLoaded("BuildCraft|Transport")) {
                BRLog.warning("ItemUtil: Could not register Build Craft pipe handler. Machines will not be able to output to BC pipes.");
    ...
    public static String getDurabilityString(ItemStack item) {
        ...
        return BRLoader.lang.localize("tooltip.durability") + " " + (item.getMaxDamage() - item.getItemDamage()) + "/" + item.getMaxDamage();
    }
